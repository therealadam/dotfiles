...
- Use mocks carefully and sparingly. Ask a human for feedback on your plan to use mocks before proceeding.
...
- We use Rubocop to catch errors and align on style. Use `rubocop` to detect
  errors and `rubocop -a` to safely autofix some classes of errors.
